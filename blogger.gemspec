...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Michal Valášek"]
  spec.email         = ["michal.valasek@gmail.com"]

  spec.summary       = %q{Utility for eleventy/github/netlify based blogging}
  # spec.description   = %q{TODO: Write a longer description or delete this line.}
  spec.homepage      = "https://github.com/michalvalasek/blogger"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/michalvalasek/blogger"
  ...
  spec.extensions    = ["ext/blogger/extconf.rb"]
